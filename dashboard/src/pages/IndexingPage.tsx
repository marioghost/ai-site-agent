...
import SourceIntelligencePanel from "../components/indexing/SourceIntelligencePanel";
import SourceIntelligencePreviewModal from "../components/indexing/SourceIntelligencePreviewModal";
import IndexingActionsBar from "../components/indexing/IndexingActionsBar";
import IndexingActivitySection from "../components/indexing/IndexingActivitySection";
import IndexingConfigCard from "../components/indexing/IndexingConfigCard";
import IndexingHelpAccordion from "../components/indexing/IndexingHelpAccordion";
import IndexingInfoBanner from "../components/indexing/IndexingInfoBanner";
import IndexingLiveRunCard from "../components/indexing/IndexingLiveRunCard";
import IndexingNextStepsGrid from "../components/indexing/IndexingNextStepsGrid";
import IndexingQueueCard from "../components/indexing/IndexingQueueCard";
import OverviewHeader from "../components/overview/OverviewHeader";
import StatusIndicator from "../components/overview/StatusIndicator";
import {
  mapIndexStatusToViewModel,
  mapQueuePreviewToViewModel,
} from "../lib/indexStatus";
import type { IndexJobStatus, IndexQueuePreview, Settings, SourceSemanticProfile } from "../types";
...
export default function IndexingPage() {
  ...
  useEffect(() => {
    if (!intelligenceTask || !status) {
      return;
    }

    if (status.run_mode !== "source_intelligence") {
      return;
    }
    ...
    if (status.id != null && completedIntelligenceJobRef.current === status.id) {
      return;
    }
    if (status.id != null) {
