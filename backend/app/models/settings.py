...
class Settings(Base):
    ...
    # RFC-100 Step 063 — Knowledge OS settings flags default ON (legacy flags stay false).
    enable_semantic_diagnostics_v2: Mapped[bool] = mapped_column(Boolean, default=True)
    cache_namespace_v2_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    memory_shadow_write_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    memory_evidence_assist_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    memory_canonical_shadow_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
