...
"$VENV/bin/pytest" \
  ...
  tests/test_memory_region_read.py \
  tests/test_memory_region_boundaries.py \
  tests/test_memory_region_integration.py \
  ...
  tests/test_maintenance_agenda_ranking.py \
  tests/test_maintenance_cycle_orchestration.py \
  tests/test_investigation_execution.py \
